...
for i in range(0, len(files)):
    if files[i] == "bicycle_complete.csv":
...
with open("Data(RawBicycle)/concattedData(RawBicycle)22.csv", 'w', newline="") as output:
...
with open("Data(RawBicycle)/concattedData(RawBicycle)23.csv", 'w', newline="") as output:
    writer = csv.writer(output, delimiter=",")
...
with open("Data(RawBicycle)/concattedData(RawBicycle)04.csv", 'w', newline="") as output:
    writer = csv.writer(output, delimiter=",")
...
with open("Data(RawBicycle)/concattedData(RawBicycle)05.csv", 'w', newline="") as output:
    writer = csv.writer(output, delimiter=",")
